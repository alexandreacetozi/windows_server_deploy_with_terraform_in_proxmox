...
# Invoke-DCProvision -ComputerName 'DC01' -ExistingDomainName corp.example -SiteName 'HQ' -InstallDNS:$true -WhatIf
# Invoke-DCProvision -ComputerName 'DC01' -ExistingDomainName corp.example -SiteName 'HQ' -InstallDNS:$true -Confirm

# Joining New Forest:
# 'DC01' | Invoke-DCProvision -NewForestDomainName corp.example -NewForestNetBIOS CORP -Verbose -WhatIf
# 'DC01' | Invoke-DCProvision -NewForestDomainName corp.example -NewForestNetBIOS CORP -Verbose -Confirm
...
.PARAMETER ComputerName
  Target server(s). Accepts pipeline input by value and by property name.
...
.EXAMPLE
  Invoke-DCProvision -ComputerName 'SRV10' -ExistingDomainName corp.example -SiteName 'HQ' -InstallDNS:$true -Confirm
